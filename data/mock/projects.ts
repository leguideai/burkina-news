...
export const projects: Project[] = [
  {
    ...
    province: 'Boulkiemdé',
    reliability: 'A',
    pndProgram: 'Programme 4.2 — Souveraineté énergétique',
    linkedIndicatorCodes: ['ELEC-CAPACITE', 'PIB-CROISSANCE'],
  ...
  },
  {
    ...
    province: 'Houet',
    reliability: 'A',
    pndProgram: "Programme 4.1 — Maîtrise de l'eau agricole",
    linkedIndicatorCodes: ['ACCES-EAU', 'CEREAL-PROD', 'PAUVRETE'],
  ...
  },
  {
    ...
    reliability: 'A',
    pndProgram: 'Programme 4.2 — Souveraineté énergétique',
    linkedIndicatorCodes: ['ELEC-CAPACITE'],
  ...
  },
  {
    ...
    province: 'Mouhoun',
    reliability: 'A',
    pndProgram: 'Programme 4.1 — Offensive agropastorale',
    linkedIndicatorCodes: ['CEREAL-PROD', 'PAUVRETE'],
  ...
  },
  {
    ...
    province: 'Kadiogo',
    reliability: 'A',
    pndProgram: 'Programme 3.6 — Numérique et Télécoms',
    linkedIndicatorCodes: ['PIB-CROISSANCE'],
  ...
  },
  {
    ...
    province: 'Comoé',
    reliability: 'A',
    pndProgram: 'Programme 4.1 — Filières agricoles',
    linkedIndicatorCodes: ['CEREAL-PROD'],
