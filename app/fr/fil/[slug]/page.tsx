        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-[#141414]">
            ...
            <div className="bg-[#faf8f5] border border-[#e6dfd5] p-3 text-right shrink-0">
              <span className="font-mono text-xs font-bold text-[#0b4627] block">10 Faits Sourcés</span>
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="divide-y divide-[#e6dfd5] bg-white border border-[#e6dfd5]">
              {brief.facts.map((fact, index) => {
                ...
                return (
                  <article key={index} className="p-6 hover:bg-[#faf8f5] transition-colors">
                    <div className="flex flex-wrap items-center justify-between gap-2 pb-2 mb-3 border-b border-[#e6dfd5]">
                      ...
                      <span className="text-[11px] font-serif text-[#737373]">
                        Source : <strong>{fact.source}</strong>
                      </span>
                    </div>

                    <p className="text-base sm:text-lg font-serif text-[#141414] leading-relaxed mb-3">
                      {fact.text}
                    </p>

                    {fact.whyWatch && (
                      <div className="bg-[#faf8f5] border border-[#e6dfd5] p-3 text-xs font-serif text-[#444444] mt-3">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-white border border-[#e6dfd5] p-5">
              ...
              <p className="text-xs font-serif text-[#555555] leading-relaxed mb-3">
                Chaque fait est consigné à la suite d'une vérification directe contre le document émetteur ou d'un constat avéré sur le terrain.
              </p>
