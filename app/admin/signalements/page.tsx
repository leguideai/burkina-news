    ...
    <div className="space-y-6">
      ...
      {convertingReport && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
          <div className="bg-white border-2 border-[#c2410c] max-w-2xl w-full shadow-2xl overflow-hidden my-auto">
            <div className="p-4 sm:p-5 border-b border-[#e6dfd5] bg-orange-50/50 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Scale size={18} className="text-[#c2410c]" />
                <h3 className="font-serif font-bold text-lg text-[#141414]">
                  Convertir le signalement en correction certifiée
                </h3>
              </div>
            ...
            <form onSubmit={handleSubmitCorrection} className="p-5 space-y-4 text-xs font-mono">
              <div>
